...
describe('Verify Surveys', function(){
   ...
   it(' Setup Surveys', function(){
      surveys.clickSurveysPage();
      // // let a = ('tr.ant-table-row.ant-table-row-level-0.row--item')

      // // let.contains('AutomationTestSurvey Framework Clone AutoTest 016480')
      // cy.get('tr.ant-table-row.ant-table-row-level-0.row--item').click('td.ant-table-cell>button[_nk="Akk681"]');
      // cy.a.b + cy.get('>td.ant-table-cell>button[_nk="Akk681"]').click();
   ...
   it(' Delegate Surveys', function(){
      surveys.clickSurveysPage();
      // const b =cy.get('tr.ant-table-row.ant-table-row-level-0.row--item')
