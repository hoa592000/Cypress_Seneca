...
#         Then I should see the framework
    Test cases to verify Login

    @View
    Scenario: Verify the login with account admin
        Given User go to the Login screen
        When User input username and password
        And User click on Login button
        Then User should see the homepage Seneca